    ...
    <div className="bg-white w-3/12 p-4 flex flex-col gap-3">
      ...
      <form class="flex justify-center items-center">
        <div class="relative w-full ">
          ...
          <input
            type="text"
            class="bg-gray-50 border border-gray-500 text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5"
            placeholder="Search"
            required
          />
        </div>
      ...
      <div className="flex flex-col gap-5">
        <div
          onClick={() => handleSettingActive("Home")}
          className="flex gap-3 cursor-pointer hover:text-gray-900 hover:font-semibold "
        >
          <svg
            width="24"
            height="24"
          ...
          <p
            ...
            className={` text-gray-700  ${
              settingactive === "Home" ? "text-gray-900 font-bold" : ""
            }`}
          >
            Home
          </p>
        ...
        <div
          onClick={() => handleSettingActive("notifications")}
          className="flex gap-3 cursor-pointer hover:text-gray-900 hover:font-semibold"
        >
          <svg
            width="24"
          ...
          <p
            ...
            className={`text-gray-700 ${
              settingactive === "notifications" ? "text-gray-900 font-bold" : ""
            }`}
          >
            Notifications
          </p>
        ...
        <div
          onClick={() => handleSettingActive("help")}
          className="flex gap-3 cursor-pointer hover:text-gray-900 hover:font-semibold"
        >
          <svg
            width="24"
          ...
          <p
            className={`text-gray-700 ${
              settingactive === "help" ? "text-gray-900 font-bold" : ""
            }`}
          >
            Help & feedback
          </p>
      ...
      <div className="flex gap-3 cursor-pointer">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clip-path="url(#clip0_424_77428)">
            <path
      ...
      <div className=" max-w-sm bg-gray-300 border border-gray-100 rounded-md cursor-pointer p-5 flex flex-col ">
        <div className="flex items-center justify-between mb-5">
          <p className="text-gray-900 font-bold">ChatGPT Integration</p>
          <svg
            width="14"
            height="14"
            viewBox="0 0 14 14"
        ...
        <p className="promotionContent mb-5">
        ...
        <div className="flex flex-row gap-5">
          <p className="promotionContent hover:font-semibold ">Dismiss</p>
          <p className="promotionContent hover:font-semibold ">What's new?</p>
        </div>
      </div>
      <br></br>{" "}
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-gray-600 text-sm font-semibold">Olivia Rhye</h1>
            <p className="promotionContent">olivia@untitledui.com</p>
          </div>
        </div>
        <svg
          className="cursor-pointer"
