...
// const router = useRouter();
  ...
  // };
  // <header className="header text-gray-500 font-semibold text-base border-b-1 border-gray-100 px-28 py-5">
    ...
    <div>
      <div className="flex flex-row">
        <Image
          ...
          width={147}
          height={32}
          className="logo flex justify-center items-center mr-8"
        />
        ...
        <div className="nav2  w-fit gap-x-2 flex justify-around items-center">
        ...
        <button className="hidden lg:hidden sm:block z-10 min-w-max min-h-max">
          <Image
